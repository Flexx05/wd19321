  ...
  { ignores: ["dist"] },
  {
    ...
    rules: {
      ...
      "no-multiple-empty-lines": [
        "error",
        { max: 1 },
      ] /** Không được xuống dòng 2 lần */,
      "no-trailing-spaces": [
        "error",
      ] /* Xóa các khoảng trắng không cần thiết ở cuối mỗi dòng */,
      "eol-last": ["error", "always"] /* Bắt buộc phải có 1 dòng cuối file */,
      indent: ["error", 2] /* Quy định về thụt lề */,
      "brace-style": [
        "error",
        "1tbs",
      ] /* Sử dụng dấu ngoặc trên cùng 1 dòng; stroustrup: sử dụng dấu ngoặc ở dòng mới */,
    },
  }
);
